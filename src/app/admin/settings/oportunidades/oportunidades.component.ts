...
@Component({
  selector: 'app-admin-settings-oportunidades',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
...
export class SettingOportunidadesComponent {
    ...
    getRecord(){
      ...
      this.service.find('oportunidades').subscribe({
        next: (value:any) => {
          this.data = value.data.oportunidades ? JSON.parse(value.data.oportunidades) : {};
    ...
    async onSubmit(event: Event) {
        ...
        formData.append("name", "oportunidades");
